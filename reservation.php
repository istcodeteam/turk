    ...
    <section class="reservation-section">
        <div class="d-flex flex-row flex-wrap w-100 h-100">
            <div class="left-side d-flex flex-column align-items-start">
                ...
                <a href="https://guest.rezervem.com.tr/Turk-Fatih-Tutak?culture=en-US" target="_blank" class="order-lg-2 order-3 btn btn-small d-flex flex-row align-items-center justify-content-between">Make Reservation <img class="ml-6 mlg-lg-8" src="./dist/img/icon-arrow-outward-white.svg" loading="lazy" width="24" height="24" alt=""></a>
...
<p class="h6 l5 text-gray">A wine list is available with over 490 international and local labels, including local wine by the glass options.</p>
<p class="h6 l5 text-gray">*A 12% additional service charge is added at the end of the experience to all food & beverage items.</p>
              </div>
                    </div>
                </div>
                <div class="accordion-item">
                    ...
                    <div id="accordion-item-2" class="accordion-item-body">
                        <div class="d-flex flex-column">
                          <p class="h6 l5 text-gray">*Due to daily micro seasonal changes, please do note we are not able to accommodate vegan, vegetarian diets, lactose intolerances, and gluten allergies (Celiac). Also note, our tasting menu emphasizes on seafood and fish produce, which we are unable to remove.</p>
                          <p class="h6 l5 text-gray">*Other adjustments related to special dietaries must be informed during the reservation or in advance to our Guest Relations team via info@turkft.com or via WhatsApp +90 530 051 83 04 for further confirmation.</p>
                        </div>
                    </div>
                </div>
