...
<head>
    <meta charset="utf-8" />
    <title>Product  | Turk Fatih Tutak</title>
            ...
            <div class="right-side">
                <div class="d-flex flex-column">
                    <div class="d-flex flex-row justify-content-between align-items-center mb-6 mb-lg-0 mt-5">
                        <p class="h3 font-500 l20 mb-lg-8 mb-0">HONEY</p>
                        <p class="d-flex d-lg-none h31 font-500 l10 mb-0">$15</p>
                    </div>
                    ...
                    <div class="d-flex flex-row justify-content-between align-items-center">
                        <p class="d-none d-lg-flex h3 font-500 l10 mb-0">$15</p>
                        <a href="javascript:void(0);" class="btn btn-small btn-brown px-8 d-flex flex-row align-items-center justify-content-center"><img class="mr-3" src="./dist/img/icon-card-white.svg" loading="lazy" alt=""> Buy Now</a>
                    </div>
                </div>
            </div>
                ...
                <div class="d-flex flex-row flex-wrap mt-4 mt-lg-6 w-100">
                    ...
                    <div class="shop-item">
                        <div class="content-box d-flex flex-column justify-content-between">
                            <p class="h5 font-500">HONEY</p>
                            <div class="d-flex flex-row justify-content-between align-items-center">
                                <p class="h31 font-500">$15</p>
                                <a href="javascript:void(0);" class="add-card"><img src="./dist/img/icon-card-white.svg" alt="add-card"></a>
                            </div>
                        </div>
